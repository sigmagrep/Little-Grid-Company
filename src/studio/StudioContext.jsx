...
export function StudioProvider({ children }) {
  ...
  const value = {
    ART_ID, LAYER_LABEL, LAYER_ACCENT, GRADIENT_TYPES, EFFECT_TYPES, DESIGN_KEYS, dirBtnCls, twoBtn, labelCls, NONE_CHIP, swatchStyle, cssStops, fieldCls, dpr,
    ...
    speedSlider, colorListEditor, particleControls, bandsField, areaRow, gradientControls, gradientPanel, glittersPanel, electronPanel, fliesPanel, tracePanel,
  };
